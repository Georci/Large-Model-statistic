...
async function fetchContractTransactions(attackName, contractAddress) {
    try {
        await Moralis.start({
            apiKey: apikey
        });
        ...
        let outputPath = `/root/WXZ/Large-Model-statistic/${attackName}_ContractTransactions.json`;
